  ...
  <b-form>
    ...
    >
      <b-form-textarea
          ...
          type="text"
          placeholder="Ejm: Cuenta con 2 dormitorios..."
          required
          autocomplete="off"
      ></b-form-textarea>
    </b-form-group>

    <b-button type="submit" variant="outline-secondary" @click="saveTask"> Crear </b-button>
  </b-form>
</template>
  ...
  methods: {
    saveTask() {
      if(this.methodSave === "update"){
        ...
        this.showToast("success", "Hecho!", "Se actualizó con exito");
      ...
      localStorage.setItem("tasks", JSON.stringify(tasks));
      this.showToast("success", "Hecho!", "Se creó con éxito");
      this.$router.push({ name: "list" });
    }
  }
}
